...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        for link in links:
            await _process_single_link(context, chat_id, link, start_time)
...
async def _process_single_link(context: ContextTypes.DEFAULT_TYPE, chat_id: int, link: str, start_time: float) -> None:
